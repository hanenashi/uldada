...
The mobile-friendly floating menu keeps the preview out of the already cramped Okoun composer. Its settings remember a 100–300% UI scale and the matching native Okoun format (Text, HTML, Radeox, or Markdown); Text is the default. Drag either lower sheet corner to resize it. The script never submits a post. If the composer already contains text, it asks before replacing it.
